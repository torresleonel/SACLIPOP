<ul>
	...
	<li class="has-sub" title="Opciones para gestionar usuario"><a href="#"><span>Gestionar Usuario</span></a>
		...
		<li class="has-sub" title="Opciones para gestionar SACLIPOP"><a href="#"><span>Gestionar Sistema</span></a>
			<ul>
			<?php if($_SESSION["nivel_usuario"] == 1){ ?>
				<li title="Click para respaldar la base de datos de SACLIPOP"><a href="respaldo_bd.php"><span>Respaldar Base de Datos</span></a></li>
				<li title="Click para restaurar la base de datos de SACLIPOP"><a href="conslt_respld_bd.php"><span>Restaurar Base de Datos</span></a></li>
				<li title="Click para consultar la bitacora de acciones en SACLIPOP"><a href="conslt_bitacora.php"><span>Consultar Bitacora</span></a></li>
			<?php } ?>
