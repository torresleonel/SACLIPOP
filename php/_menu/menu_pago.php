			...
			<li class="has-sub" title="Opciones para gestión de pagos"><a href="#"><span>Gestionar Pagos</span></a>
				<ul>
					<li class="has-sub" title="Opciones para configurar el proceso de pago"><a href="#"><span>Configuración</span></a>
						<ul>
							<li title="Click para modificar el sueldo mensual del personal"><a href="modf_sueldo_mes_a.php"><span>Modificar Sueldo Mensual</span></a></li>
							...
							<li class="has-sub" title="Opciones para gestionar las primas"><a href="#"><span>Primas</span></a>
								<ul>
									<li title="Click para crear nueva prima"><a href="gest_prima_a.php"><span>Gestionar Primas</span></a></li>
					...
					<li class="has-sub" title="Opciones para calcular pagos"><a href="#"><span>Calcular Pagos</span></a>
						<ul>
							<li title="Click para calcular salario del personal"><a href="calc_salario_a.php"><span>Salario</span></a></li>
							<li title="Click para calcular bono vacacional del personal"><a href="calc_bono_vac_a.php"><span>Bono Vacacional</span></a></li>
							<li title="Click para calcular aguinaldos del personal"><a href="calc_aguinaldo_a.php"><span>Aguinaldos</span></a></li>
						</ul>
					</li>
					<li class="has-sub" title="Opciones para consultar pagos"><a href="#"><span>Consultar Pagos</span></a>
						<ul>
							<li class="has-sub" title="Opciones para consultar salario"><a href="#"><span>Salario</span></a>
								<ul>
									<li title="Click para consultar por periodo el salario individual por trabajador"><a href="conslt_salario_ind_a.php"><span>Consulta Individual</span></a></li>
									<li title="Click para consultar por periodo el salario en general de los trabajadores"><a href="conslt_salario_gen_a.php"><span>Consulta General</span></a></li>
								</ul>
							</li>
							<li class="has-sub" title="Opciones para consultar bono vacacional"><a href="#"><span>Bono Vacacional</span></a>
								<ul>
									<li title="Click para consultar por periodo el bono vacacional individual por trabajador"><a href="conslt_bono_vac_ind_a.php"><span>Consulta Individual</span></a></li>
									<li title="Click para consultar por periodo el bono vacacional en general de los trabajadores"><a href="conslt_bono_vac_gen_a.php"><span>Consulta General</span></a></li>
								</ul>
							</li>
							<li class="has-sub" title="Opciones para consultar aguinaldos"><a href="#"><span>Aguinaldos</span></a>
								<ul>
									<li title="Click para consultar por periodo el aguinaldo individual por trabajador"><a href="conslt_aguinaldo_ind_a.php"><span>Consulta Individual</span></a></li>
									<li title="Click para consultar por periodo los aguinaldos en general de los trabajadores"><a href="conslt_aguinaldo_gen_a.php"><span>Consulta General</span></a></li>
								</ul>
							</li>
						</ul>
					</li>
