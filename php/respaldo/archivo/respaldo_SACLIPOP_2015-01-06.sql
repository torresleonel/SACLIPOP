...
CREATE TABLE `aguinaldo` (
  ...
  `fecha_calculo` date NOT NULL COMMENT 'Fecha en que se realizo el calculo de aguinaldo para el trabajador',
  ...
  KEY `cedula` (`cedula`),
  CONSTRAINT `aguinaldo_ibfk_1` FOREIGN KEY (`id_aguinaldo`) REFERENCES `laboral` (`cedula`) ON UPDATE CASCADE
...
CREATE TABLE `bitacora` (
  ...
  `sentencia` varchar(300) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `bitacora` VALUES (1,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal de Alto Nivel\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-05 05:38:44'),(2,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Fijo\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-05 05:38:44'),(3,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Contratado\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-05 05:38:44'),(4,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,laboral.*\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE trabajador.cedula = \'30303030\'','2015-01-05 05:38:48'),(5,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal de Alto Nivel\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-05 05:39:06'),(6,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Fijo\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-05 05:39:06'),(7,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Contratado\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-05 05:39:06'),(8,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,laboral.*\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE trabajador.cedula = \'40404040\'','2015-01-05 05:39:09'),(9,'full','Leonel','Torres','INSERT INTO bono_vacac (ini_vacac,fin_vacac,reincorpor,dia_vacac,dia_adicional,sueldo_dia,total_dia_v,total_dia_adic,total_pagar,cedula)\r\n						VALUES (\'2015-1-5\',\'2015-1-28\',\'2015-1-29\',\'15\',\'3\',\'200\',\'3000\',\'600\',\'3600\',\'40404040\')','2015-01-05 05:39:26'),(10,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal de Alto Nivel\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-05 05:41:02'),(11,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Fijo\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-05 05:41:02'),(12,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Contratado\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-05 05:41:02'),(13,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,laboral.*\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE trabajador.cedula = \'40404040\'','2015-01-05 05:41:04'),(14,'full','Leonel','Torres','UPDATE bono_vacac \r\n						SET ini_vacac = \'2015-1-5\',fin_vacac = \'2015-1-28\',reincorpor = \'2015-1-29\',dia_vacac = \'15\',dia_adicional = \'3\',sueldo_dia = \'200\',total_dia_v = \'3000\',total_dia_adic = \'600\',total_pagar = \'3600\' \r\n						WHERE id_bono = \'1\'','2015-01-05 05:41:12'),(15,'full','Leonel','Torres','SELECT * FROM usuario WHERE usuario = \'full\' AND clave = \'81dc9bdb52d04dc20036dbd8313ed055\'','2015-01-06 02:08:48'),(16,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal de Alto Nivel\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 02:09:02'),(17,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Fijo\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 02:09:02'),(18,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Contratado\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 02:09:02'),(19,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal de Alto Nivel\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 02:09:37'),(20,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Fijo\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 02:09:37'),(21,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Contratado\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 02:09:37'),(22,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,laboral.*\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE trabajador.cedula = \'40404040\'','2015-01-06 02:09:39'),(23,'full','Leonel','Torres','INSERT INTO bono_vacac (ini_vacac,fin_vacac,reincorpor,dia_vacac,dia_adicional,sueldo_dia,total_dia_v,total_dia_adic,total_pagar,cedula)\r\n						VALUES (\'2015-1-5\',\'2015-1-28\',\'2015-1-29\',\'15\',\'3\',\'200\',\'3000\',\'600\',\'3600\',\'40404040\')','2015-01-06 02:09:48'),(24,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal de Alto Nivel\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 04:36:36'),(25,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Fijo\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 04:36:36'),(26,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Contratado\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 04:36:36'),(27,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal de Alto Nivel\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 04:37:20'),(28,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Fijo\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 04:37:20'),(29,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Contratado\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 04:37:20'),(30,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal de Alto Nivel\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 04:39:30'),(31,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Fijo\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 04:39:30'),(32,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Contratado\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 04:39:30'),(33,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,laboral.*\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE trabajador.cedula = \'30303030\'','2015-01-06 04:39:32'),(34,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal de Alto Nivel\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 04:40:30'),(35,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Fijo\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 04:40:30'),(36,'full','Leonel','Torres','SELECT trabajador.cedula,nombre,apellido,cargo,sueldo_mensual\r\n				FROM trabajador\r\n				JOIN laboral ON laboral.cedula = trabajador.cedula\r\n				WHERE rango = \'Personal Contratado\'\r\n				AND estado = 1\r\n				ORDER BY sueldo_mensual\r\n				DESC','2015-01-06 04:40:30'),(37,'full','Leonel','Torres','SELECT * FROM usuario WHERE usuario = \'full\' AND clave = \'81dc9bdb52d04dc20036dbd8313ed055\'','2015-01-06 16:56:31'),(38,'full','Leonel','Torres','SELECT * FROM usuario WHERE usuario = \'full\' AND clave = \'81dc9bdb52d04dc20036dbd8313ed055\'','2015-01-07 01:06:10'),(39,'full','Leonel','Torres','SELECT * FROM usuario WHERE usuario = \'full\' AND clave = \'81dc9bdb52d04dc20036dbd8313ed055\'','2015-01-07 01:09:51');
...
-- Dump completed on 2015-01-06 20:39:56
