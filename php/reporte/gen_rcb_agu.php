			...
			<div id="pagina">
				<div id="content">
					...
					<div id="wrapper">
						...
						?>
						<div id="steps">
							<form id="formElem" name="formElem" action="recibo_aguin.php" method="post">
								<fieldset class="step">
									<legend>Datos</legend>
									<div class='centro'>
										<div class='campo'>
									...
									<div class="bot_cent">
										<input type="submit" name="generar" value="Generar" id="boton" title="Click para generar el recibo de aguinaldos" />
									</div>
								</fieldset>
							</form>
						</div>
