	...
	<body>
		<div id="cuerpo">
			...
			<div id="pagina">
				...
				<form name="usuario" action="2_preg_segur.php" method="POST" autocomplete="off" class="sesion">
					...
					<br>
					<INPUT TYPE="submit" value="Verificar" id="boton" id="ingresar" title="Click para verificar nombre de usuario">
				</form>
			</div>
		</div>
	</body>
